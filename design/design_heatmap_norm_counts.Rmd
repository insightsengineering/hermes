...
# For some reason the hermes_data object is a single assay now, not sure if I altered a global variable on this branch
...
draw_heatmap <- function(datasetInput,
  ...
  Heatmap_plot <- ComplexHeatmap::Heatmap(filteredData)
  draw(Heatmap_plot)
  }
