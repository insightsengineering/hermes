...
- Replaces [`gQCnorm()`](https://github.roche.com/Rpackages/rnaseqTools/blob/dae3c425cf5bf0d45848323f722b558ce3bbf851/R/gSE_Processing.R#L368)
- remove the `qcfilterApply` argument - the filtering will be done outside this method so that it is transparent to the user.

## Control function

Replaces [`norm_control()`](https://github.roche.com/Rpackages/rnaseqTools/blob/dae3c425cf5bf0d45848323f722b558ce3bbf851/R/gSE_Processing.R#L431) and might contain more arguments if needed.
...
- Replaces [`normalize_cpm()`](https://github.roche.com/Rpackages/rnaseqTools/blob/dae3c425cf5bf0d45848323f722b558ce3bbf851/R/gSE_NormMethods.R#L106)
...
- Replaces [`normalize_rpkm()`](https://github.roche.com/Rpackages/rnaseqTools/blob/dae3c425cf5bf0d45848323f722b558ce3bbf851/R/gSE_NormMethods.R#L121)
...
- replaces [`normalize_tpm()`](https://github.roche.com/Rpackages/rnaseqTools/blob/dae3c425cf5bf0d45848323f722b558ce3bbf851/R/gSE_NormMethods.R#L72)
...
- Replaces [`normalize_voom()`](https://github.roche.com/Rpackages/rnaseqTools/blob/5bcd842758741f16512597092fa2b655d7194508/R/gSE_NormMethods.R#L144)
