...
This is to replace the legacy function [`draw_heatmap()`](https://github.roche.com/Rpackages/rnaseqTools/blob/dae3c425cf5bf0d45848323f722b558ce3bbf851/R/gSE_Metrics.R#L306).
...
setMethod(
  ...
  definition = function(x, y = "counts") {
    ...
    #annotation_col <- tern::explicit_na(as.character(colData(object)$TechnicalFailureFlag))
    .HermesDataCor(
      sample_cor_matrix,
