...
The `HermesData` object will lead to error message in ggplot since all `LowExpressionFlag` values are NA. We may need one test in `assert_that()` to dectect if all values in the `LowExpressionFlag` are NA.
