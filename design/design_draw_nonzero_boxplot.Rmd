...
#### Question in the example the oulier are labeled, here are not 
# should I modify taking out the geom_point and leaving outlier option with label instead? not sure if it is possible to do both
