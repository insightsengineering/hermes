...
```{r initialize}
#if we want to utilize this, we would need to add functions
...
Identified by lower quartile minus 1.5*IQR (default) or user-defined threshold: <b> `r params$top_gene_min_threshold` </b> 
