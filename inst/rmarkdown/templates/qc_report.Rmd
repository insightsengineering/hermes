...
params:
  ...
  top_gene_n_top: 
    ...
    value: NULL # default 10L by specifing NULL, alternatively 5 [if top_gene_n_top not NULL, top_gene_min_threshold must be NULL]
    input: numeric
  top_gene_min_threshold:
    label: "Minimum expression level threshold"
    value: 50000 # default specifing NULL, alternatively 5 [if top_gene_min_threshold not NULL, top_gene_n_top must be NULL]
    input: numeric
...
Total number of genes before filtering: `r nrow(result)`
