...
#'
#' This generates volcano plot for HermesDataDiffExpr object at default setting.
#'
#'
#' @param object (`HermesDataDiffExpr`)\cr input.
#'
#' @return A `ggplot` object for volvano plot with default settings.
...
setMethod(
  ...
  definition = function(object,
                        ...
                        logFC.threshold = 2.5) {
    assert_that(
      is.numeric(adj.P.Val.threshold),
      is.numeric(logFC.threshold),
      adj.P.Val.threshold <= 1 & adj.P.Val.threshold >= 0
    )
